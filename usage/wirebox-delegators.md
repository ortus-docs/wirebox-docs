...
WireBox supports the concept of [object delegation](https://en.wikipedia.org/wiki/Delegation_\(object-oriented_programming\)) in a simple, expressive DSL.
...
1. [Inheritance](https://en.wikipedia.org/wiki/Inheritance_\(object-oriented_programming\)) (IS A relationship)
